## Why did the RCaaS RSE Team create this repository?
This repository was created to address a number of goals:

1. Showcase setting up a flask python webapp using uv and VS code.
